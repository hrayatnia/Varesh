...
public extension View {
    ...
    func navigationBarSearch(_ searchText: Binding<String>,
                             ...
                             searchClicked: @escaping () -> Void = {}) -> some View {
        return overlay(SearchBar<AnyView>(text: searchText,
                                          ...
                                          searchClicked: searchClicked).frame(width: 0, height: 0))
    }

    @available(iOS, introduced: 13.0, deprecated: 15.0, message: "Use .searchable() and .onSubmit(of:) instead.")
    @available(macCatalyst, introduced: 13.0, deprecated: 15.0, message: "Use .searchable() and .onSubmit(of:) instead.")
    func navigationBarSearch<ResultContent: View>(_ searchText: Binding<String>,
                                                  placeholder: String? = nil,
                                                  hidesNavigationBarDuringPresentation: Bool = true,
                                                  hidesSearchBarWhenScrolling: Bool = true,
                                                  cancelClicked: @escaping () -> Void = {},
        ...
        return overlay(SearchBar(text: searchText,
                                 ...
                                 resultContent: resultContent).frame(width: 0, height: 0))
    }
}
